...
synthax::primitive::envelope::adsr_x::adsr_x(param* del, param* atk, param* atkh, param* dec, param* sus, param* sush, param* rel, node* signal)
{
...
synthax::primitive::envelope::adsr_x::~adsr_x() {
...
synthax::primitive::envelope::adsr_x* synthax::primitive::envelope::adsr_x::get_copy() {
...
void synthax::primitive::envelope::adsr_x::evaluateBlockPerformance(unsigned firstFrameNumber, unsigned numSamples, float* sampleTimes, unsigned numConstantVariables, float* constantVariables, float* buffer) {
