...
void synthax::primitive::base::wave_table::set_render_info(float sample_rate, unsigned block_size, unsigned max_frame_number, float max_frame_start_time) {
...
void synthax::primitive::base::wave_table::done_rendering() {
...
void synthax::primitive::base::wave_table::update_mutated_params() {
...
void synthax::primitive::base::wave_table::fft(int N, double *ar, double *ai)
{    
    int i, j, k, L;            /* indexes */
...
float synthax::primitive::base::wave_table::makeAddWaveTable(int len, double* ar, double* ai, double scale, double topFreq) {
    fft(len, ar, ai);
...
void synthax::primitive::base::wave_table::makeAddAllWaveTables(double sampleRate, unsigned overSamp, unsigned constantRatioLimit, double baseFrequency, double topFrequency) {
    ...
    for (; maxHarms >= 1; maxHarms >>= 1) {
        ...
        scale = wave_table::makeAddWaveTable(tableLen, ar, ai, scale, topFreq);
        topFreq *= 2;
