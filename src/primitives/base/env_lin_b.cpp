...
void synthax::primitive::base::env_lin_b::ephemeral_random(random* rng) {
...
void synthax::primitive::base::env_lin_b::set_render_info(float sr, unsigned block_size, unsigned max_frame_number, float max_frame_start_time) {
    assert(!isPrimitive);
    done_rendering();
    sampleRate = sr;
...
void synthax::primitive::base::env_lin_b::update_mutated_params() {
...
void synthax::primitive::base::env_lin_b::fillFromParams() {
    if (splineType == 0) {
