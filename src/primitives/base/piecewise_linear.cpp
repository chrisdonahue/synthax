...
void synthax::primitive::abstract::piecewise_linear::ephemeral_random(random* rng) {
...
void synthax::primitive::abstract::piecewise_linear::set_render_info(float sr, unsigned block_size, unsigned max_frame_number, float max_frame_start_time) {
    assert(!isPrimitive);
    done_rendering();
    sampleRate = sr;
...
void synthax::primitive::abstract::piecewise_linear::done_rendering() {
...
void synthax::primitive::abstract::piecewise_linear::update_mutated_params() {
...
void synthax::primitive::abstract::piecewise_linear::fillFromParams() {
    if (splineType == 0) {
