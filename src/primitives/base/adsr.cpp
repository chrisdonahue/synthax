...
void synthax::primitive::base::adsr::set_render_info(float sample_rate, unsigned block_size, unsigned max_frame_number, float max_frame_start_time) {
    node::set_render_info(sample_rate, block_size, max_frame_number, max_frame_start_time);
	done_rendering();
    sampleRate = sample_rate;
}

void synthax::primitive::base::adsr::done_rendering() {
    node::done_rendering();
...
void synthax::primitive::base::adsr::update_mutated_params() {
...
void synthax::primitive::base::adsr::fillFromParams() {
