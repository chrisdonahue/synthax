...
void synthax::primitive::base::adsr_b::set_render_info(float sample_rate, unsigned block_size, unsigned max_frame_number, float max_frame_start_time) {
	done_rendering();
...
void synthax::primitive::base::adsr_b::fillFromParams() {
